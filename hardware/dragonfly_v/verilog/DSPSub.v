module DSPSub( input1, input2, out, carry_out);
    ...
    defparam i_sbmac16_sub.BOTOUTPUT_SELECT = 2'b00 ; //lower [15:0] of adder/subtractor
    ...
    defparam i_sbmac16_sub.TOPOUTPUT_SELECT = 2'b00 ; // higher [31:16] of adder/subtractor

...
main:
	...
	sw	s0,1096(sp)	#,
	addi	s0,sp,1104	#,,
# bubblesort.c:10:   uchar bsort_input[] = {
	lui	a5,%hi(.LC0)	# tmp92,
	...
	mv	a0,a4	#, tmp93
	call	memcpy		#
# bubblesort.c:14:   const int bsort_input_len = 0x100;
	li	a5,256		# tmp97,
	sw	a5,-28(s0)	# tmp97, bsort_input_len
# bubblesort.c:22:   int maxindex = bsort_input_len - 1;
	lw	a5,-28(s0)		# tmp99, bsort_input_len
	addi	a5,a5,-1	#, tmp98, tmp99
	sw	a5,-24(s0)	# tmp98, maxindex
# bubblesort.c:24:   while (maxindex > 0) {
	j	.L2		#
.L6:
# bubblesort.c:29:     for (i = 0; i < maxindex; i++) {
	sw	zero,-20(s0)	#, i
# bubblesort.c:29:     for (i = 0; i < maxindex; i++) {
	j	.L3		#
.L5:
# bubblesort.c:32:       if (bsort_input[i] > bsort_input[i + 1]) {
...
# bubblesort.c:32:       if (bsort_input[i] > bsort_input[i + 1]) {
	bleu	a4,a5,.L4	#, _1, _3,
# bubblesort.c:34:         bsort_input[i] ^= bsort_input[i + 1];
...
# bubblesort.c:35:         bsort_input[i + 1] ^= bsort_input[i];
...
# bubblesort.c:36:         bsort_input[i] ^= bsort_input[i + 1];
...
# bubblesort.c:24:   while (maxindex > 0) {
	...
	bgtz	a5,.L6	#, tmp131,
# bubblesort.c:44:   *((unsigned int *)0x2000) = 0xff;
	li	a5,8192		# _17,
# bubblesort.c:44:   *((unsigned int *)0x2000) = 0xff;
	li	a4,255		# tmp132,
	sw	a4,0(a5)	# tmp132, *_17
# bubblesort.c:46:   return *((int *)bsort_input);

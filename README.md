**This is Andy Hu's branch of GB3 project with completely re-written CPU core. The new core (under [hardware/dragonfly_v/verilog](https://github.com/smhs4/gb3-resources/tree/Andy-Hu/hardware/dragonfly_v/verilog)) achieves higher performance than the reference design (under [hardware/processor/verilog](https://github.com/smhs4/gb3-resources/tree/Andy-Hu/hardware/processor/verilog)), while consuming less than half of logical resources and lower power**
